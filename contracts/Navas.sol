...
contract Navas is ERC20 {
    uint constant _initial_supply = 100000 * (10 ** 18); // setting variable for how many of your own tokens are initially put into your wallet, feel free to edit the first number but make sure to leave the second number because we want to make sure our supply has 18 decimals
    ...
    constructor() public ERC20("Navas", "NS") {
